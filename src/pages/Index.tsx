...
const Index = () => {
  ...
  return <div className="min-h-screen">
      <nav className="absolute top-0 left-0 right-0 flex justify-between items-center px-8 py-6 z-50">
        <img 
          src={`${import.meta.env.BASE_URL}lovable-uploads/045a54d4-e9fd-4885-bdb1-a02182b034a0.png`}
          alt="Brand Logo" 
          className="h-10 w-10"
        />
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          ...
          >
            <div className="relative">
              <img 
                src={`${import.meta.env.BASE_URL}lovable-uploads/9f8cef4a-1d4a-4bd1-b1eb-e85750b2173a.png`}
                alt="Logo Black"
                className="w-full logo-image transition-all duration-200"
              />
              <img 
                src={`${import.meta.env.BASE_URL}lovable-uploads/850fea03-55ef-4c5a-a383-9922824d3f5d.png`}
                alt="Logo Pink"
      ...
      <div className="bg-gray-50 py-20">
        ...
        <div className="relative h-[600px] overflow-hidden">
          <img 
            src={`${import.meta.env.BASE_URL}lovable-uploads/161c86b3-b1a6-465b-a4f9-9843d1ead1a8.png`}
            alt="Podcast Hosts" 
      ...
      <footer className="border-t py-8">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            <img 
              src={`${import.meta.env.BASE_URL}lovable-uploads/ab081bb6-32f6-4e5b-9545-85d35726c04c.png`}
